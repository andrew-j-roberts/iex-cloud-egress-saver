...
function SolaceTopicSubscriber(messageReceivedCallback) {
  var solaceclient = {};
  solaceclient.session = null;
  solaceclient.subscriptions = {};
  solaceclient.messageReceivedCallback = messageReceivedCallback;
  ...
  // PROMISIFIED THE CONNECT LOGIC FOR OUR SOLACE CLIENT
  solaceclient.connect = function() {
    return new Promise((resolve, reject) => {
      ...
      solaceclient.session.on(solace.SessionEventCode.MESSAGE, function(message) {
        solaceclient.messageReceivedCallback(message.getBinaryAttachment());
      });
    });
  };
...
export default SolaceTopicSubscriber;
